...
public class TweetTrendsAdminDriver {
	...
	public static void main(String args[]) throws TwitterException {
		...
		System.out.println("\n" + "**Welcome to the Tweet Trends 10-Day Administrative Interface**");
		...
		do {
			...
			case 3:
				...
				app.printSomeQueryResults(queryStatement, sinceDate, untilDate, 40);
				break;
	...
	public static String getValidDate() {
		...
		while (doesItMatch == false) {
			System.out.println(
					"An invalid date was entered." + " Enter one with the following format: yyyy-mm-dd " + "\n");
